...
My research focuses on <span style="color:red; font-weight:bold;">neurodegenerative diseases</span>, with an emphasis on developing <span style="color:blue; font-weight:bold;">machine learning</span> models to analyze <span style="color:green; font-weight:bold;">multiomics</span> data, including imageomics, proteomics, and genomics. My research aims to: 1) improve diagnostic accuracy using accessible data; 2) advance our understanding of the biological mechanisms underlying neurodegeneration; and 3) develop ready-to-use research and clinical toolkits.<br><br>
