...
My research focuses on <span style="color:red; font-weight:bold;">neurodegenerative diseases</span>, with an emphasis on developing <span style="color:blue; font-weight:bold;">machine learning</span> models to analyze <span style="color:green; font-weight:bold;">multiomics</span> data, including imageomics, proteomics, and genomics. My research aims to: 
1. Improve diagnostic accuracy using accessible data;
2. Understand the biological mechanisms underlying neurodegeneration;
3. Develop ready-to-use research/clinical toolkits.<br><br>
