...
1. 配置谷歌学术引用爬虫：
    ...
    1. 在github本仓库页面的`Settings -> Secrets and aariables -> Actions secrets and variables -> New repository secret`中，添加`GOOGLE_SCHOLAR_ID`变量：`name=GOOGLE_SCHOLAR_ID`、`value=SCHOLAR_ID`。
